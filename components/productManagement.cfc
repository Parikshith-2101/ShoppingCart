<cfcomponent>
    ...
    <cffunction name = "addProduct" access = "public" returnType = "struct">
        ...
        <cfif len(trim(arguments.productId))>
            ...
            <cfset local.qryProductNameCheck = qryProductData(
                productName = arguments.productName,
                subCategoryId = arguments.subCategoryId,
                productId = arguments.productId
            )>
            <cfif local.qryProductNameCheck.RecordCount>
                <cfset local.result['errorStatus'] = "true">
                <cfset local.result['resultMsg'] = "">
            <cfelseif local.qryFetchProduct.RecordCount>
                <cfset local.result['errorStatus'] = "false">
    ...
    <cffunction name = "qryProductImage" access = "remote" returnFormat = "JSON">
        <cfargument name = "productId">
